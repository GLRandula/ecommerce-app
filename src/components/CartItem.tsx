...
import { decresaeQuantity, incresaeQuantity, removeFromCart } from "@/redux/shoppersSlice";
    ...
    <div className="w-full grid grid-cols-5 mb-4 border py-2">
      ...
      <div className="col-span-5 md:col-span-3 flex items-center justify-between py-4 md:py-0 px-4 lg:px-0">
        ...
        <div className="flex w-1/3 items-center font-bold gap-6 text-lg">
          <button onClick={handleMinus} className="w-6 h-6 bg-gray-100 text-sm flex items-center justify-center hover:bg-darkOrange/10 cursor-pointer border-[1px] border-gray-300 hover:border-darkOrange hoverEffect">
            <FaMinus />
          </button>
          <p>{item?.quantity}</p>
          <button onClick={handlePlus} className="w-6 h-6 bg-gray-100 text-sm flex items-center justify-center hover:bg-darkOrange/10 cursor-pointer border-[1px] border-gray-300 hover:border-darkOrange hoverEffect">
            <FaPlus />
          </button>
        </div>
        <div className="flex w-1/3 items-center font-bold gap-6 text-lg">
